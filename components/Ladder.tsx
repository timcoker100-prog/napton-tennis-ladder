    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto p-4">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          ...
          <a href="/instructions" className="py-4 bg-blue-600 text-white rounded-2xl font-medium active:bg-blue-700">📋 How to Use</a>
          <a href="/admin" className="py-4 bg-amber-600 text-white rounded-2xl font-medium active:bg-amber-700">⚙️ Admin</a>
          <button onClick={() => { if (confirm("Logout?")) { localStorage.removeItem('currentUser'); window.location.href = '/login'; } }} className="py-4 bg-red-600 text-white rounded-2xl font-medium active:bg-red-700">Logout</button>
        </div>
